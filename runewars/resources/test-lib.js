...
var settings;
var runewarsGame = Game.get( 'runewars' );
if( runewarsGame != null ) {
	settings = runewarsGame.masterSettings;
} else {
	settings = Settings.shared;
}
settings.addSettingsFrom( 'base.settings' );
...
useLibrary( 'project:runewars/resources/namedobj.js' );
...
var projBase = 'project:runewars/resources/text/';
